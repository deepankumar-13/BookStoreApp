...
<div style="display: flex; justify-content: flex-end; margin: 20px 90px 0 0;">
    <form action="addbook.jsp" method="get">
        <button class="buy-now-btn" type="submit">Add Book</button>
    </form>
</div>


<div>
    <h1>Welcome back <span class="typing">Admin..!!</span></h1>
</div>
    ...
    <div class="book-card">
        ...
        <div class="card-right">
            ...
            <form action="OperationServlet" method="get">
                ...
                <button class="buy-now-btn" type="submit">Rem ove</button>
            </form>
        </div>
    </div>
<%
